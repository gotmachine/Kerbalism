...
namespace KERBALISM
{
    class Radiator : PartModule, IModuleInfo
    {
        ...
        // rmb status
        [KSPField(guiActive = true, guiActiveEditor = true, guiName = "_", guiFormat = "F2", guiUnits = "/s")]
        ...
        public void Start()
        {
            ...
            Fields["cooling_rate"].guiName = outputdef.displayName + " output: ";
            Fields["input_rate"].guiName = inputdef.displayName + " input: ";
        ...
        public override string GetInfo()
        {
            ...
            info += outputdef.displayName + ": <color=#00ff00>" + Lib.HumanReadableRate(GetMaxVoidOutput(temperature_min)) + "</color>\n";
            info += inputdef.displayName + ": <color=#ff0000>" + Lib.HumanReadableRate(input_rate_min * GetMaxVoidOutput(temperature_min)) + "</color>\n";
            info += "\n";
            info += "<b>Max coolant temp:</b> " + Lib.HumanReadableTemp(temperature_max) + " :\n";
            info += outputdef.displayName + ": <color=#00ff00>" + Lib.HumanReadableRate(GetMaxVoidOutput(temperature_max)) + "</color>\n";
            info += inputdef.displayName + ": <color=#ff0000>" + Lib.HumanReadableRate(input_rate_max * GetMaxVoidOutput(temperature_max)) + "</color>\n";
            return info;
        }
